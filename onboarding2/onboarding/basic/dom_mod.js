...
const connectBtn = `<a href="./secure" ><button class=" interact-button rounded-lg bg-harpie font-display hover:bg-harpie-600 focus:ring-harpie-200 border-2 border-harpie  duration-100 transition ease-in-out inline-block py-2 text-base rounded-sm tracking-wide text-white transition-colors ease-in-out md:px-8 lg:px-10 px-6 focus:ring cur btnn ">Connect</button></a>`;
